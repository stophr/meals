// IFPS produce PLU codes (4-digit conventional; organic = a leading 9 -> 5 digits).
// Source: https://github.com/ankane/plu (IFPS-derived, https://www.ifpsglobal.com/plu-codes).
// Generated data file - do not edit by hand. Regenerate from the upstream JSON.

export const PLU_CODES: Record<string, string> = {
  '3000': 'Alkmene Apples',
